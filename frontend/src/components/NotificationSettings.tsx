...
const NotificationSettings = ({email, username, rate, streak}) => {
        ...
        <CardContent>
          <div className="bg-gray-50 p-4 rounded-lg border">
            <div className="text-sm">
              <div className="font-medium mb-2">Subject: Medication Alert - {username}</div>
              <div className="text-muted-foreground">
                <p className="mb-2">Hello,</p>
                <p className="mb-2">
                  This is a reminder that {username} has not taken her medication today.
                </p>
                <p className="mb-2">
                  Please check with her to ensure she takes her prescribed medication.
                </p>
                <p>
                  Current adherence rate: {rate} ({streak}-day streak)
                </p>
              </div>
            </div>
          </div>
